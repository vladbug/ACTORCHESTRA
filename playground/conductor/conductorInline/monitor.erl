...
verify_loop() ->
    receive
                                        ...
                                        {slow_proc_add10, slow_central_server, {ok, Result2}, Context} ->
                                            ...
                                            receive
                                                ...
                                                {slow_central_server, client, {ok, FinalResult}, Context} ->
                                                    ...
                                                    %% Verify context consistency and show the complete processing chain
                                                    print_and_log("✓ CONTEXT PRESERVED: ~p throughout the entire processing chain~n", [Context]),
        ...
        %% Legacy: Handle old PID-based messages for backward compatibility
